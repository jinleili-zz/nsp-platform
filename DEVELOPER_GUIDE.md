...
> 模块路径：`github.com/jinleili-zz/nsp-platform`
> Go 版本：1.25.6
...
| 模块 | 包路径 | 职责 |
|------|--------|------|
| **logger** | `logger` | 统一结构化日志，支持三分类体系（Access/Platform/Business）和日志轮转 |
| **trace** | `trace` | 分布式链路追踪，B3 协议 Header 传播，自动关联日志 trace_id |
| **auth** | `auth` | AK/SK HMAC-SHA256 签名认证，防篡改、防重放 |
...
```go
// import "github.com/jinleili-zz/nsp-platform/lock"
...
```go
// import "github.com/jinleili-zz/nsp-platform/config"
...
```go
// import "github.com/jinleili-zz/nsp-platform/trace"
...
```go
// import "github.com/jinleili-zz/nsp-platform/taskqueue"
