// Simple TaskQueue Example
// This example demonstrates basic workflow submission and execution
//
// Prerequisites:
//   - PostgreSQL running on localhost:5432
//   - Redis running on localhost:6379
//   - Database: CREATE DATABASE taskqueue_simple;
...
const (
	...
	callbackQueue = "simple_callbacks"
	taskQueue     = "simple_tasks"
)

func main() {
	log.SetFlags(log.LstdFlags | log.Lmicroseconds)
	log.Println("========================================")
	log.Println("Simple TaskQueue Example")
	log.Println("========================================")
	...
	engine, err := taskqueue.NewEngine(&taskqueue.Config{
		...
		QueueRouter: func(queueTag string, priority taskqueue.Priority) string {
			return taskQueue // Simple: all tasks go to same queue
		},
	}, broker)
	if err != nil {
